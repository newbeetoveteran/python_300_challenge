# Find union
# Concept : using set and union
# Remember - 1. List allows duplicates while sets dont
#            2. To find union of lists, you must convert it to set first
...
if set_size2 == 0:
    ...
    set_union = static_set1.union(static_set2)
